...
// Issues: 
// 1. Missing return types on some asynchronous methods
// 2. Avoid using 'any' type
// 3. Inconsistent usage of promises in function signatures
// 4. Methods do not specify types for the data being returned or accepted