...
// Issues:
// - Improper return types for async functions 
// - Too broad type for data in generic methods 
// - Lack of explicit return types for some methods 
// - Inconsistent use of promises 
// - Unnecessary elses in conditional checks 
// - Could use better type definitions